...
Abortos: $\bar{y}=0.3333$, $s_y=0.6697$ y $cv_y=2.009$.\\ 
...
%SOLUTION
{\begin{enumerate}
\item Ratas no modificadas genéticamente: $\bar y=147.2927$ mg/dl,  $s^2_y=280.7332$ (mg/dl)$^2$, $s=16.7551$ mg/dl y $cv_y=0.1138$.\\
Ratas modificadas genéticamente: $\bar y=106.3295$ mg/dl,  $s^2_y=35.265$ (mg/dl)$^2$, $s=5.9384$ mg/dl y $cv_y=0.0558$.\\
Así, la media de las ratas modificadas genéticamente es más representativa ya que su coeficiente de variación es menor.
\item Ratas no modificadas genéticamente: $g_1=0.0064$.\\
Ratas modificadas genéticamente: $g_1-0.1503$.\\
Por tanto, la distribución de ratas modificadas genéticamente es más asimétrica ya que el coeficiente de asimetría está más alejado de 0.
\item Ratas no modificadas genéticamente: $g_2=-0.6416$.\\
Ratas modificadas genéticamente: $g_2-1.0602$.\\
Por tanto, el apuntamiento de la distribución de ratas modificadas genéticamente es menos normal ya que el coeficiente de apuntamiento está más alejado de 0.
\item Ratas no modificadas genéticamente: $z(145)=-0.1368$.\\
Ratas modificadas genéticamente:: $z(130)=3.986$.\\
Por tanto, un nivel de colesterol de 130 mg/dl en ratas modificadas genéticamente es relativamente mayor que 145 mg/dl en ratas no modificadas genéticamente.
\end{enumerate}
}
%RESOLUTION
{
