\documentclass[a4paper,dvips,titlepage]{article}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\hypersetup{pdfautor={Alfredo Sánchez Alberca (asalber@ceu.es)}, pdftitle={Ejercicios de Estad\'istica} } 
\usepackage{url}
...
\shadowbox{\Huge \textbf{\textsf{\quad \textcolor[rgb]{0.00,0.00,0.50}{EJERCICIOS DE ESTADÍSTICA}\quad}}}\\
   ...
   {\Large \textsf{\textcolor[rgb]{0.50,0.00,0.25}{Curso: 1º del Grado en Farmacia}}}
   }
\author{
