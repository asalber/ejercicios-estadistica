% Created by tikzDevice version 0.10.1 on 2016-11-01 19:34:07
...
\path[fill=fillColor] (194.93, 76.30) --
	(194.93,122.78) --
	(257.97,122.78) --
	(257.97, 76.30) --
	cycle;
...
\path[draw=drawColor,line width= 1.2pt,line join=round] (230.95, 76.30) -- (230.95,122.78);

\path[draw=drawColor,line width= 0.4pt,dash pattern=on 4pt off 4pt ,line join=round,line cap=round] (104.86, 99.54) -- (194.93, 99.54);

\path[draw=drawColor,line width= 0.4pt,dash pattern=on 4pt off 4pt ,line join=round,line cap=round] (284.99, 99.54) -- (257.97, 99.54);

\path[draw=drawColor,line width= 0.4pt,line join=round,line cap=round] (104.86, 87.92) -- (104.86,111.16);

\path[draw=drawColor,line width= 0.4pt,line join=round,line cap=round] (284.99, 87.92) -- (284.99,111.16);

\path[draw=drawColor,line width= 0.4pt,line join=round,line cap=round] (194.93, 76.30) --
	(194.93,122.78) --
	(257.97,122.78) --
	(257.97, 76.30) --
	(194.93, 76.30);
...
\path[fill=fillColor] (199.43,134.39) --
	(199.43,180.87) --
	(244.46,180.87) --
	(244.46,134.39) --
	cycle;

\path[draw=drawColor,line width= 1.2pt,line join=round] (237.71,134.39) -- (237.71,180.87);

\path[draw=drawColor,line width= 0.4pt,dash pattern=on 4pt off 4pt ,line join=round,line cap=round] (199.43,157.63) -- (199.43,157.63);

\path[draw=drawColor,line width= 0.4pt,dash pattern=on 4pt off 4pt ,line join=round,line cap=round] (275.99,157.63) -- (244.46,157.63);

\path[draw=drawColor,line width= 0.4pt,line join=round,line cap=round] (199.43,146.01) -- (199.43,169.25);

\path[draw=drawColor,line width= 0.4pt,line join=round,line cap=round] (275.99,146.01) -- (275.99,169.25);

\path[draw=drawColor,line width= 0.4pt,line join=round,line cap=round] (199.43,134.39) --
	(199.43,180.87) --
	(244.46,180.87) --
	(244.46,134.39) --
	(199.43,134.39);

\path[draw=drawColor,line width= 0.4pt,line join=round,line cap=round] (118.37,157.63) circle (  2.25);
...
\node[text=drawColor,rotate= 90.00,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at ( 34.80, 99.54) {C};

\node[text=drawColor,rotate= 90.00,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at ( 34.80,157.63) {D};

\node[text=drawColor,rotate= 90.00,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at ( 34.80,215.72) {S};

\node[text=drawColor,rotate= 90.00,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at ( 34.80,273.81) {V};
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.20] at (192.68,332.61) {\bfseries Diagrama de caja de edades según estado civil};

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.20] at (192.68, 15.60) {Edad};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (361.35,361.35);
\definecolor{drawColor}{RGB}{0,0,0}
