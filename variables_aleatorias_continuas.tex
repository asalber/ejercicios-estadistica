...
\begin{center}
\includegraphics[scale=0.8]{img/vac-2}
\end{center}
Calcular:
\begin{enumerate}
...
\item ¿Cuántos se espera que tengan su nivel de colesterol por encima de 250 mg/dl?
...
\begin{enumerate}
\item Hallar $P(X\leq 120 \text{ mg}/ 100 \text{ ml})$.
\item ¿Qué porcentaje de diabéticos tendrá niveles entre 90 y 120 mg/100 ml?
\item Encontrar un valor que tenga la propiedad de que el 25\% de los diabéticos tenga un nivel de glucosa $X$ por
